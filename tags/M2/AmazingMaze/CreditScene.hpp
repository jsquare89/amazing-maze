...
namespace AmazingMaze
{
    ...
    private:
        ...
        /** Model for credits menu (3D menu with names). */
        boost::shared_ptr<C3DMenu> m_p3DNamesMenu;

        /** Model for credits menu (3D menu with emails). */
        boost::shared_ptr<C3DMenu> m_p3DEmailsMenu;
